...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/galaxytunnel2026/Galaxy-Tunnel-APP"
    const val APP_API_URL = "https://api.github.com/repos/galaxytunnel2026/Galaxy-Tunnel-APP/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/galaxytunnel2026/Galaxy-Tunnel-APP/main/PRIVACY.md"
